...
wawa5111 = wawa5111.sort_values(by='Date')
...
raw_values = series.Volume
diff_values = raw_values.iloc[1:]

# transform data to be supervised learning
supervised = timeseries_to_supervised(diff_values, 1)
supervised_values = supervised.values

supervised['Date'] = series.Date.iloc[1:]

# split data into train and test-sets
train, test = supervised['Date'] < '2019-01-01', supervised['Date'] > '2019-01-01'
train = train.loc[train]
test = test.loc[test]

train, test = supervised_values[0:190], supervised_values[190:]
...
# report performance
mae = mean_absolute_error(raw_values[191:], predictions)
rmse = sqrt(mean_squared_error(raw_values[191:], predictions))
print('Test RMSE: %.3f' % rmse)
# line plot of observed vs predicted
pyplot.plot(raw_values[190:])
